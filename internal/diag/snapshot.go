...
// Snapshot là bản tóm tắt chỉ đọc của toàn bộ artifact trong thư mục output.
// Mọi hàm quy tắc chỉ nhận Snapshot, không truy cập trực tiếp file system.
type Snapshot struct {
	...
	LoadErrors []string // Thất bại tải khác NotExist, phân biệt "không có dữ liệu" và "lỗi khi đọc"
}

// Load đọc toàn bộ artifact từ store, xây dựng bản tóm tắt chỉ đọc.
// File không tồn tại coi là "không có dữ liệu" (trường giữ giá trị zero); lỗi khác ghi vào LoadErrors.
