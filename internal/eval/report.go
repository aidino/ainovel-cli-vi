...
// Aggregate tổng hợp kết quả từng case thành suite, và tính toán cổng chặn tổng thể: bất kỳ FAIL→FAIL, nếu không bất kỳ WARN→WARN.
...
// WriteReport viết report.json (máy đọc) và report.md (người đọc) vào outDir.
...
// Summary là kết luận tóm tắt dành cho stdout.
