...
// SameModelID kiểm tra hai định danh model có trỏ về cùng một model chuẩn hay không (bỏ qua hậu tố ngày, hoa thường, khác biệt dấu chấm/gạch ngang).
...
// isDatedModelSuffix kiểm tra chuỗi có dạng "-20250514" (gạch ngang + 8 chữ số).
