...
// gen_models.go kéo toàn bộ model từ OpenRouter API, sinh baseline biên dịch models_generated.go.
...
const (
	...
	// maxModelAgeDays quyết định giữ lại các model bao nhiêu ngày tuổi. Quá tuổi này coi là đã lỗi thời (GPT-3.5,
	// GPT-4 bản gốc, Llama 2, Mistral 7b...), loại thẳng để giảm kích thước binary và nhiễu khi truy vấn.
	// nhất quán với bộ lọc runtime của pricing.go.
	maxModelAgeDays = 730
)

// nhất quán với pricing.go.
...
// isTooOld kiểm tra timestamp created có vượt quá maxModelAgeDays không.
