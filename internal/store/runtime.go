...
// RuntimeStore quản lý hàng đợi thời gian chạy thống nhất và nhật ký mỗi task.
...
// AppendQueue nối thêm một bản ghi hàng đợi thời gian chạy, và tự động phân bổ số thứ tự tăng dần.
...
// LoadQueue đọc toàn bộ các mục hàng đợi thời gian chạy được bền bỉ hóa hiện tại.
...
// AppendTaskLog nối thêm nhật ký chạy của một task nào đó.
...
// LoadTaskLog đọc toàn bộ nhật ký chạy của một task nào đó.
...
// Reset dọn dẹp hàng đợi thời gian chạy và nhật ký task.
