...
// StateChange bản ghi thay đổi trạng thái nhân vật/thực thể.
type StateChange struct {
	...
	OldValue string `json:"old_value,omitempty"` // Trước khi thay đổi (lần đầu xuất hiện có thể để trống)
